...
const ProductCard = ({ seller, name, img, description, price, amountCollected, handleClick }) => {
//   const remainingDays = daysLeft(deadline);
  ...
  return (
    <div className="sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer ml-10" onClick={handleClick}>
      <img src={img} alt="" className="w-full h-[158px] object-cover rounded-[15px]"/>
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <img src={gifUrl} alt="user" className="w-1/2 h-1/2 object-contain"/>
          </div>
