...
const TransactionCard = ({ seller, name, description, img, price, amountCollected, status, pId, handleClick }) => {
      ...
      <div className="flex flex-col p-10"  onClick={handleClick}>
        ...
        <div className="flex justify-between flex-wrap mt-[15px] gap-2">
          <div className="flex flex-col">
            ...
            <p className="mt-[3px] font-epilogue font-normal text-[12px] leading-[18px] text-[#808191] sm:max-w-[200px]">Price: {price} GoerliETH</p>
          </div>
        </div>

        <div className="flex items-center mt-[20px] gap-[12px]">
          <div className="w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]">
            <img src={img} alt="user" className="w-1/2 h-1/2 object-contain"/>
          </div>
