...
const CreateProduct = () => {
    ...
    async function uploadMetadataToIPFS(){
        ...
        const nftJSON = {
            name, description, image: imgURL //, reviews: null, ratings: null
        }
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true)
            ...
            form.metadataURL = await uploadMetadataToIPFS();
            await createProduct({
                ...form,
    ...
    return (
        <div className="flex flex-col place-items-center mt-10">                
            ...
            <div>
                <label className="block text-white text-[16px] font-medium leading-[22px] font-semibold mb-[10px]" htmlFor="image">Upload Image *</label>
        ...
        // font-semibold font-medium text-[16px] leading-[22px] text-white mb-[10px]
